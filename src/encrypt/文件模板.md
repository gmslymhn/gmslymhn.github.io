...
例如:
```
<video width="100%" controls autoplay> <source src="http://lz.tyut.tech/lz?fid=iOocd33e4n1e&pwd=4kvv&isNewd=https://innlab.lanzn.com" type="video/mp4"> 您的浏览器不支持MP3播放 </video>
```
:::


### PDF标签
<PdfPreview pdfUrl="http://lz.tyut.tech/lz?fid=iRRZF36otyzc&pwd=5c23&isNewd=https://innlab.lanzn.com" />
```
<PdfPreview pdfUrl="http://lz.tyut.tech/lz?fid=iRRZF36otyzc&pwd=5c23&isNewd=https://innlab.lanzn.com" />
```
